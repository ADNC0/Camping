...
#Importar paquete base de datos 
import dj_database_url 
...
SECRET_KEY = 'django-insecure-#0%1dubg+j(*&l(p#7r-kl131fl+exqqeuf5_k$%e+b&)sv=&5'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

#ALLOWED_HOSTS = []
ALLOWED_HOSTS = venv.list('ALLOWED_HOSTS', default=['camping-dfae.onrender.com', 'localhost', '127.0.0.1'])
...
MIDDLEWARE = [
    'django.middleware.security.SecurityMiddleware',
     #LIBRERIA
    'whitenoise.middleware.WhiteNoiseMiddleware',  # Usado para servir archivos estáticos
